...
const InputField = ({ id, label, type = 'text', placeholder, value, onChange, error, icon: Icon, ...props }) => {
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      >
        <div className="absolute left-4 top-1/2 -translate-y-1/2" style={{ color: focused ? '#6366F1' : '#9CA3AF' }}>
          <Icon size={17} />
        </div>
        <input
          id={id}
          ...
          className="w-full bg-transparent outline-none pl-11 pr-4 py-3.5 text-sm font-medium"
          style={{ color: '#020617' }}
          {...props}
        />
        {isPassword && (
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 text-sm font-semibold transition-colors"
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ background: 'linear-gradient(90deg, #6366F1, #8B5CF6, #60A5FA)', top: -1 }}
        />
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="relative w-full py-3.5 rounded-2xl text-white font-bold text-sm flex items-center justify-center gap-2 mt-2 overflow-hidden"
            style={{
              background: loading
                ? '#A5B4FC'
        ...
        <div className="flex items-center gap-3 my-5">
          ...
          <span className="text-xs font-medium" style={{ color: '#475569' }}>or continue with</span>
          <div className="flex-1 h-px" style={{ background: '#E2E8F0' }} />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <motion.button
              ...
              whileHover={{ background: '#F1F5FF', borderColor: '#C7D2FE', scale: 1.02 }}
              whileTap={{ scale: 0.97 }}
